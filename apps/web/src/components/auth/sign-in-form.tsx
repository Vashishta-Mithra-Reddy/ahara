...
export default function SignInForm({
						...
						try {
							...
							if (res.ok) {
								...
								const isCompleted = Array.isArray(status)
									...
									: !!status?.completed;
								router.push(isCompleted ? "/dashboard" : "/onboarding");
							} else {
	...
	return (
		<div className="w-full max-w-md p-6 font-jakarta">
			...
			className="w-full flex items-center justify-center gap-1.5 font-medium cursor-pointer rounded-xl border-2 border-foreground/20 bg-background px-6 py-3 text-center transition-all duration-500 hover:bg-foreground/5 hover:text-foreground/90"
			>
