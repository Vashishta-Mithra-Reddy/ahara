...
const buttonVariants = cva(
	"relative z-10 flex shrink-0 items-center justify-center gap-2 rounded-xl border-2 border-foreground/20 bg-background px-6 py-3 text-base font-medium text-foreground transition-all duration-500 cursor-pointer focus-visible:ring-[3px] focus-visible:ring-ring/50 focus-visible:border-ring hover:bg-foreground/5 hover:text-foreground/90 disabled:pointer-events-none disabled:opacity-50 [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0",
	{
		variants: {
			variant: {
				default:
					"bg-background text-foreground border-foreground/20 hover:bg-foreground/5 hover:text-foreground/90",
				destructive:
				...
				ghost:
					"bg-transparent hover:bg-foreground/10 hover:text-foreground",
